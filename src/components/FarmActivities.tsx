...
export const FarmActivities = ({
  ...
  activities: Omit<FarmActivity, "image" | "description">[];
}) => {
  ...
  return (
    <div className="m-4">
      <Dialog>
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Make sure to double check the dates. Click submit when you're
              done.
            </DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter>
            <Button type="submit" onClick={addFarmActivity}>
              Submit
            </Button>
          </DialogFooter>
        </DialogContent>
      ...
      <div className="mt-4 space-y-2 rounded-lg bg-white p-6 shadow-sm">
        <h2 className="text-xs font-semibold text-gray-800 hover:text-gray-900">
          Head Section Priority
        </h2>
        <p className="text-xs text-gray-500">
          Please be advised that only a max of 3 activities can be active at a
          time.
        </p>
        {activities
          ...
          .map((activity) => (
            <div
              key={activity.id}
              className="flex items-center justify-between p-1 rounded-lg border border-gray-200 hover:border-gray-300 transition-colors duration-200 bg-white/50 backdrop-blur-sm shadow-sm hover:shadow-md"
            >
              <h2 className="text-xs font-semibold text-gray-800 hover:text-gray-900">
                {activity.name}
              </h2>
